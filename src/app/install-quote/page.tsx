    ...
    <div className="theme-editorial min-h-screen bg-background text-foreground">
      ...
      <ExperimentProvider>
        <main id="main" tabIndex={-1} className="flex flex-col outline-none">
          <HeroSection defaultInstallType="residential" skipServiceStep formName="starlink_install_quote" />
          ...
          <TrackRecordSection />
          <FaqSectionAlt />
          <CtaSection defaultService="residential" skipServiceStep formName="starlink_install_quote" />
        </main>
      </ExperimentProvider>
      <FunnelFooter />
    </div>
