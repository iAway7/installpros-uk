      ...
      {scrollable && (
        <>
          <button
            ...
            className="absolute -left-3 top-1/2 hidden h-11 w-11 sm:flex -translate-y-1/2 items-center justify-center rounded-full border border-border bg-white text-foreground shadow-raised transition duration-quick ease-ds hover:bg-secondary md:-left-5"
          >
          ...
          <button
            ...
            onClick={() => scrollByCard(1)}
            className="absolute -right-3 top-1/2 hidden h-11 w-11 sm:flex -translate-y-1/2 items-center justify-center rounded-full border border-border bg-white text-foreground shadow-raised transition duration-quick ease-ds hover:bg-secondary md:-right-5"
          >
