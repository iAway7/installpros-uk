  ...
  return (
    <>
      <button
        ...
        className={cn(
          "inline-flex h-10 w-10 items-center justify-center rounded-md border border-field bg-background text-foreground transition-colors duration-200",
          "hover:border-field-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--selection)/0.15)]",
          className,
        )}
      >
