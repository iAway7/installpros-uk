...
export function Modal({
  ...
  const btn =
    "inline-flex h-control-aux items-center justify-center rounded-lg border px-4 text-body font-medium transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--selection)/0.15)] disabled:cursor-not-allowed disabled:opacity-40";
